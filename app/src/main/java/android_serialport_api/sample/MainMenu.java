...
public class MainMenu extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.testAll).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				startActivity(new Intent(MainMenu.this, TestAllActivity.class));
			}
		});
        ...
        buttonConsole.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(MainMenu.this, SerialPortTestActivity.class));
			}
		});
        ...
        buttonAbout.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(MainMenu.this, TestPortActivity.class));
